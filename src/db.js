const books = [
    ...
    },
    {
      ...
      page: 328,
      description: "A dystopian novel depicting a totalitarian society and government surveillance.",
      rating: 4.9,
    ...
    },
    {
      ...
      page: 180,
      description: "A novel exploring the American Dream and the Roaring Twenties.",
      rating: 4.7,
    ...
    },
    {
      ...
      author: "J.R.R. Tolkien",
      page: 1178,
      description: "An epic fantasy trilogy about the quest to destroy a powerful ring.",
      rating: 4.9,
